 ...
 */
extern struct json_object* json_object_new_binary(int binary_type, const char *binary, size_t length);
...
extern int json_object_get_binary_type(struct json_object *jso);
extern void json_object_set_binary_type(struct json_object *jso, int binary_type);
extern void json_object_set_binary(struct json_object *jso, const char *binary, size_t length);
